...
void FlexiTimer2::set(unsigned long units, double resolution, void (*f)()) {
	...
	func = f;
		...
		|| defined (__AVR_ATmega1284P__) || defined (__AVR_AT90USB1287__) || defined (__AVR_ATmega1281__) || defined (__AVR_ATmega2560__) || defined (__AVR_ATmega128RFA1__) || defined(__AVR_ATmega256RFR2__)
	TIMSK2 &= ~(1<<TOIE2);
