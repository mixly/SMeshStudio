...
const uint8_t PROGMEM digital_pin_to_port_PGM[] = {
		// PORTLIST
		// -------------------------------------------
		PD	, // PD 2 ** 0 ** USART1_RX INT2
		PD	, // PD 3 ** 1 ** USART1_TX INT3
		PE	, // PE 6 ** 2 ** D2  		INT6
		PE	, // PE 5 ** 3 **  		PWM	INT5
		PE	, // PE 2 ** 4 **
		PE	, // PE 3 ** 5 ** D5	PWM
		...
		PD	, // PD 1 ** 21 ** I2C_SDA	INT0
		PD	, // PD 0 ** 22 ** I2C_SCL	INT1
...
const uint8_t PROGMEM digital_pin_to_timer_PGM[] = {
		// TIMERS
		// -------------------------------------------
		NOT_ON_TIMER	, // PD 2 ** 0 ** USART1_RX INT2
		NOT_ON_TIMER	, // PD 3 ** 1 ** USART1_TX INT3
		NOT_ON_TIMER	, // PE 6 ** 2 ** D2  		INT6
		TIMER3C			, // PE 5 ** 3 **  		PWM	INT5
		NOT_ON_TIMER	, // PE 2 ** 4 **
		TIMER3A			, // PE 3 ** 5 ** D5	PWM
		TIMER3B			, // PE 4 ** 6 ** 		PWM	INT4
		NOT_ON_TIMER	, // PE 7 ** 7 ** D7 		INT7
		TIMER2A			, // PB 4 ** 8 ** 		PWM8   /enc vcc old
		TIMER1C			, // PB 7 ** 9 ** 		PWM9
		...
		NOT_ON_TIMER	, // PB 5 ** 20 ** LIS3DH INT(POWER CONNECTED VCC)  // button
		NOT_ON_TIMER	, // PD 1 ** 21 ** I2C_SDA	INT0
		NOT_ON_TIMER 	, // PD 0 ** 22 ** I2C_SCL	INT1
		NOT_ON_TIMER 	, // PD 5 ** 23 ** RFTX  LED0
		NOT_ON_TIMER	, // PD 6 ** 24 ** RFRX  LED1
		NOT_ON_TIMER 	, // PD 7 ** 25 ** 	    LED2
		TIMER0B			, // PB 6 ** 26 **  DS2411
		NOT_ON_TIMER	, // PG 5 ** 27 ** VCC_SD_CONTROL LOW ENABLE
		NOT_ON_TIMER	, // PD 4 ** 28 ** RF212_IRQ
		NOT_ON_TIMER	, // PG 3 ** 29 ** TOSC2 32.768KRC
		NOT_ON_TIMER	, // PG 4 ** 30 ** TOSC1 32.768KRC
		NOT_ON_TIMER	, // PG 1 ** 31 ** RF212_RST
		NOT_ON_TIMER	, // PG 2 ** 32 **  SPI_CS_SD SI7005 POWER  //old enc cs
		NOT_ON_TIMER	, // PF 6 ** 33 ** VCC_ENC_CONTROL LOW ENABLE
		NOT_ON_TIMER 	, // PG 0 ** 34 ** RF212_SLP
		NOT_ON_TIMER	, // PF 7 ** 35 ** SPI_CS_ENC
		NOT_ON_TIMER	, // PE 0 ** 36 ** USART0_RX CP2104
		NOT_ON_TIMER	, // PE 1 ** 37 ** USART0_TX CP2104
