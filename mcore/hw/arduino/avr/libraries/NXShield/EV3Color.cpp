...
EV3Color::EV3Color(uint8_t i2c_address):EV3SensorAdapter(i2c_address)
{
}
uint8_t	EV3Color::setMode(MODE_Color m)
{
    if ( m < MODE_Color_ReflectedLight ||
        m >  MODE_Color_MeasureColor ) {
        return -1;
    }
