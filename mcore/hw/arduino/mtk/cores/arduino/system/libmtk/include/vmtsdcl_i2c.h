...
typedef enum
{
   VM_TS_DCL_I2C_CMD_SINGLE_WRITE_ASYNC, /* Single write of none-blocking mode */
   VM_TS_DCL_I2C_CMD_SINGLE_READ_ASYNC, /* Single read of none-blocking mode */
   VM_TS_DCL_I2C_CMD_CONT_WRITE_ASYNC, /* Continue write of none-blocking mode */
   VM_TS_DCL_I2C_CMD_CONT_READ_ASYNC, /* Continue read of none-blocking mode */
   VM_TS_DCL_I2C_CMD_WRITE_AND_READ_ASYNC, /* Write and read of none-blocking mode */
