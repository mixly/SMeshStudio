...
*   VM_TS_DCL_EINT_CTRL_SET_HW_DEBOUNCE_T deboun_time; //Declare a VM_TS_DCL_EINT_CTRL_SET_HW_DEBOUNCE_T variable.
...
typedef enum{
	...
	VM_TS_DCL_EINT_CMD_SET_HW_DEBOUNCE, /* EINT set hardware debounce command. */
...
typedef struct
{
 ...
 /******************************************************************
 * DESCRIPTION
 *	 This struct is for VM_TS_DCL_EINT_CMD_SET_HW_DEBOUNCE control command,used in vm_ts_dcl_control as parameter.
 *	 You can find the sample code in the description of VM_TS_DCL_EINT_CTRL_CMD.
 *******************************************************************/
typedef struct
{
 	VMUINT32	  debounce_time;/* HW debounce time. the unit is ms.*/
} VM_TS_DCL_EINT_CTRL_SET_HW_DEBOUNCE_T;
