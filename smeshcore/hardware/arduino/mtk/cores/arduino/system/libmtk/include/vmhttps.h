 ...
 */
typedef void (*wps_send_set_channel_rsp_cb)( VMUINT32 req_id,
                                                 VMUINT8  channel_id,
                                                 VMUINT8  result);
 ...
 * replied.
 */
typedef void (*wps_unset_channel_rsp_cb)( VMUINT8 channel_id,
                                              VMUINT8 result);
 ...
 */
typedef void (*wps_send_release_all_req_rsp_cb)( VMUINT8 result);
 ...
 */
typedef void (*wps_send_wps_termination_ind_cb)(void);
 ...
 */
typedef void (*wps_send_http_rsp_cb)( VMUINT16 request_id,  /* request ID */
 ...
 */
typedef void (*wps_send_read_content_rsp_cb)( VMUINT16 request_id,          /* Request ID */
 ...
 */
typedef void (*wps_send_cancel_rsp_cb)( VMUINT16 request_id,
                                            VMUINT8  result);
 ...
 */
typedef void (*wps_send_status_query_rsp_cb)( VMUINT8 status);

/* 
 * post data indication
 */
typedef void (*wps_post_ind_cb)(VMUINT16 request_id, VMUINT8 seq_num, VMUINT8 result);
