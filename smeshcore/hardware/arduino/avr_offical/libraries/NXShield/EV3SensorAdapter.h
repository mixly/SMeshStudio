...
#ifndef	EV3_SENSOR_ADAPTER_H
#define	EV3_SENSOR_ADAPTER_H
...
class EV3SensorAdapter : public NXShieldI2C
{
public:
    ...
    byte	getMode( );
    /** Read the value from the sensor attached to EV3SensorAdapter
    */
    int readValue();
